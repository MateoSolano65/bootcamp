        ...
        {!hideHeader && (
          <>
            <Image
              ...
              height="100"
            />
            <div className="h4 mb-2 text-center">{customTitle}</div>
          </>
        )}
        {/* Alert */}
        {show ? (
        ...
        {!fieldsHidden.surname && (
          <Form.Group className="mb-2" controlId="inputSurname">
            ...
            <Form.Control
              ...
              {...setInputSurname}
              required
              disabled={fieldsDisabled.surname}
            />
          </Form.Group>
        )}
        {!fieldsHidden.idType && (
          ...
          >
            ...
            <Form.Select
              ...
              required
              disabled={fieldsDisabled.idType}
            >
        ...
        {!fieldsHidden.idNumber && (
          <Form.Group className="mb-2" controlId="inputIDNumber">
            ...
            <Form.Control
              ...
              {...setInputIDNumber}
              required
              disabled={fieldsDisabled.idNumber}
            />
          </Form.Group>
        )}
        {!fieldsHidden.phone && (
        ...
        {!fieldsHidden.address && (
          <Form.Group className="mb-2" controlId="inputAddress">
            ...
            <Form.Control
              ...
              {...setInputAddress}
              required
              disabled={fieldsDisabled.address}
            />
          </Form.Group>
        )}
